...
public class Network {
    ...
    private static Callback callOnRegistered;
    ...
    public static void writeNewUser(String login, String nickname, String password) {
        try {
            if (socket == null || socket.isClosed()) {
                connect();
            }
            out.writeUTF("/register " + login + " " + password + " " + nickname);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
