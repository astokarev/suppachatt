...
public class Controller implements Initializable {
    ...
    @FXML
    TextField msgField, loginField, setLoginField, setNickname;

    @FXML
    HBox msgPanel, authPanel, registerPanel;

    @FXML
    PasswordField passField, setPassField;
    ...
    public void setAuthenticated(boolean authentificated) {
        ...
        setLoginField.setVisible(!authentificated);
        setPassField.setVisible(!authentificated);
        setNickname.setVisible(!authentificated);
        registerPanel.setManaged(!authentificated);
        if (!authentificated) {
            nickname = "";
        }
    }
    ...
    public void recordNewUser() {
        Network.writeNewUser(setLoginField.getText(), setPassField.getText(), setNickname.getText());
        Alert registerSuccess = new Alert(Alert.AlertType.INFORMATION, "Аккаунт "+setNickname.getText() + "создан");
        registerSuccess.showAndWait();
        setLoginField.setVisible(false);
        setPassField.setVisible(false);
    ...
    private File setMessageHistoryFile() {
        messageHistoryFile = new File("src/main/java/chatApp/client/logs/" + nickname + ".cmh");
